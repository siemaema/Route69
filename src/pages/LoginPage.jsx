// Finalny kod z poprawką zabezpieczającą przed niechcianym logowaniem po Enterze
import React, { useEffect, useState, useRef } from "react";
import { motion, AnimatePresence } from "framer-motion";
import { useDispatch, useSelector } from "react-redux";
import { loginUser } from "../store/slices/loginThunk";
...
export default function LoginPage() {
  ...
  useEffect(() => {
    const handleKeyDown = (e) => {
      // zabezpieczenie przed wywoływaniem logowania globalnie
      const targetTag = e.target.tagName.toLowerCase();
      const isInput = ["input", "textarea"].includes(targetTag);
      if (e.key === "Enter" && !isLoggedIn && isInput) {
        if (!data.email) {
